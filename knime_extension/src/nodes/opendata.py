...
class USCensus2020Node:
    ...
    Tract6Fips = knext.StringParameter("Tract FIPS (6-digits)", "The Tract to investigate, input * for all tracts", "*")
...
class UScensusACSNode:
    ...
    cols=knext.StringParameter("US Census ACS Variable Names", "The US Census Variable list to use", "GEO_ID,B02001_001E,B02001_002E,B02001_003E")
    ...
    year=knext.StringParameter("US Census ACS5 Year Label", "The Year label of dataset", "2020")
